-- ============================================================================
-- Migración Planificación — 300 · Radiografía del proyecto VIEJO (SOLO LECTURA)
-- ============================================================================
-- ⚠ Correr en el SQL Editor del proyecto de PLANIFICACIÓN (lppceugnfuzuvzclhlce),
--   NO en el del portal. Devuelve una celda JSON: copiarla y pegarla en el
--   chat. No modifica nada.
--
-- Con esto se escriben las CREATE TABLE planificacion_* exactas (tipos, defaults,
