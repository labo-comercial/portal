-- ============================================================================
-- Migración LABO — 200 · Radiografía del proyecto VIEJO (SOLO LECTURA)
-- ============================================================================
-- ⚠ Correr en el SQL Editor del proyecto de LABO (rhajlvmneyvgqlyeyjsd),
--   NO en el del portal. Devuelve una celda JSON: copiarla y pegarla en el
--   chat. No modifica nada.
--
-- Con esto se escriben las CREATE TABLE labocomercial_* exactas (tipos, defaults,
